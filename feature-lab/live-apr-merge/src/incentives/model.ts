...
export const statusLabel=(state:string)=>({refunded:'Creation fee refunded',refund_pending:'Creation fee refund pending',refund_exception:'Refund verification needs review',queued:'Deployment queued',deploying:'Creating vault',checking:'Checking availability',needs_attention:'Needs operator attention',awaiting_funding:'Awaiting incentive program funding',depositable:'Depositable',claimable:'Premium claimable',active:'Position active',matured:'Ready to withdraw',completed:'Completed',fixed_awaiting_funding:'Deposit confirmed · vault has not started',occupied:'Fixed side occupied',no_position:'No position held'}[state]??state.replaceAll('_',' '))
