...
try{
  ...
  await page.locator('[data-claim-error] summary').click()
  ...
  await page.locator('[data-deployment-transactions] summary').click()
  await page.getByRole('button',{name:'Check progress',exact:true}).click()
  await expect(page.getByText('Verifying vault',{exact:true})).toBeVisible()
