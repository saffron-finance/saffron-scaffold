...
export function FundingAccounting({budget}:{budget:Budget}){
  ...
  return <Accounting aria-label={'Funding and accounting for '+programReference(budget.id)}>
    ...
    <TableFrame><DetailTable aria-label={'Accounting details for '+programReference(budget.id)}>
